...
parser.add_argument('--data_train', metavar='DATATRAIN',
                    help='path to image dataset')
parser.add_argument('--data_test', metavar='DATATEST',
                    help='path to image dataset')
...
parser.add_argument('', '--model_name', default='RaGAN', type=str,
                    help='Directory to store evaluation results')
...
parser.add_argument('-gpu', '--gpu_id', default=0, type=int,
                    help='GPU id to use.')
parser.add_argument('-f', '--freeze_epoch', default=100, type=int,
...
parser.add_argument('-d', '--dataset', default='celeba-hq', type=str,
                    metavar='DATASET', help='Dataset name to train on')
parser.add_argument('-d', '--mask_dataset', default='nvidia', type=str,
                    metavar='MASKDATASET', help='Mask dataset name to train on')
